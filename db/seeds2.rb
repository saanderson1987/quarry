...
users = User.create([{username: "Harry",
password: "password"}{username: "Sue",
password: "password"}{username: "Betty",
password: "password"}{username: "James",
password: "password"}{username: "Bobo",
password: "password"}{username: "Samuel",
password: "password"}])

topics = Topic.create([{name: "General"}{name: "Death"}{name: "Computer Programming"}{name: "Inspiration"}{name: "Philosophy of Everyday Life"}{"Science"}])
...
answers= Answer.create ([
  {
    author_id: 3,
    text: "Have you tried looking in the pantry?",
    question_id: 0
